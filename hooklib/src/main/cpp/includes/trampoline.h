...
#ifndef SANDLOCK_TRAMPOLINE_H
#define SANDLOCK_TRAMPOLINE_H
...
#if defined(__i386__)
#define SIZE_REPLACEMENT_LOCK_TRAMPOLINE 4 * 9
...
#define SIZE_INLINE_LOCK_TRAMPOLINE 4 * 24
...
#define OFFSET_INLINE_ADDR_LOCK_METHOD 4 * 22
...
#define SIZE_REPLACEMENT_LOCK_TRAMPOLINE 4 * 5
...
#define SIZE_INLINE_LOCK_TRAMPOLINE 4 * 17
...
#define OFFSET_INLINE_LOCK_ART_METHOD 4 * 15
#define OFFSET_INLINE_ADDR_LOCK_CODE_ENTRY 4 * 16
...
#define SIZE_REPLACEMENT_LOCK_TRAMPOLINE 4 * 8
...
#define SIZE_INLINE_LOCK_TRAMPOLINE 4 * 23
...
#define OFFSET_INLINE_LOCK_ART_METHOD 4 * 19
#define OFFSET_INLINE_ADDR_LOCK_CODE_ENTRY 4 * 21
...
extern "C" void INLINE_LOCK_TRAMPOLINE();
extern "C" void REPLACEMENT_LOCK_TRAMPOLINE();
extern "C" void CALL_ORIGIN_TRAMPOLINE();

#if defined(__arm__)
#include <unistd.h>
extern "C" void DIRECT_JUMP_TRAMPOLINE_T();
extern "C" void INLINE_LOCK_TRAMPOLINE_T();
